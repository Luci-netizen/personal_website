class ParseBibtex {
	...
	get type() {
		let reg = /^@[a-z]+/;
		if (this._source.match(reg) != null) return this._source.match(reg)[0];
		else return null;
	}
